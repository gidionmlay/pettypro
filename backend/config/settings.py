...
INSTALLED_APPS = [
    'daphne', # Daphne must be before staticfiles if using it
...
# dj-rest-auth Configuration (v7.x format)
REST_AUTH = {
    'USE_JWT': True,
    'JWT_AUTH_COOKIE': None,  # Return JWT in response body, not cookies
